...
```jsonc title="socials.json"
{
  ...
  "link": "https://github.com/louisescher/kshell" // The actual destination of the link
}
```
...
info: # A TOML-like list of information about the project
  - text: GitHub # Text for this info
    link: https://github.com/louisescher/kshell # Optional if you want to link to somewhere
    icon:
