---
title: "Getting Started with kshell"
description: "Find out how to configure kshell."
...
Thanks for going with kshell as your theme of choice! Let's get you set up. You can create a new Astro project with this theme by running:
...
import kshell from './package/integration';
...
The theme color defaults to `#2323FF`. The Twitter handle doesn't have a default value, and the relevant meta tags will be omitted if it's not provided.
...
kshell supports both [Lucide](https://lucide.dev) and [Simple Icons](https://simpleicons.org).
...
```jsonc title="socials.json"
{
  ...
  "link": "https://git.khalidrafi.tech/kshell" // The actual destination of the link
}
```
...
```mdx
---
title: "Getting Started with kshell" # The title of the post
description: "Find out how to configure kshell." # The description of the post
image: "../assets/kshell.png" # The image to be used as the OG image, referenced with a relative path.
...
```mdx
---
title: kshell # The title of the project
date: 12-29-2024 # Date of publication
description: kshell is a terminal-inspired theme for Astro, built using Astro and TypeScript. # Description of the project
image: ../assets/kshell.png # The image to be used as the OG image, referenced with a relative path
info: # A TOML-like list of information about the project
  - text: GitHub # Text for this info
    link: https://git.khalidrafi.tech/kshell # Optional if you want to link to somewhere
    icon:
...
kshell uses the [`node`](https://docs.astro.build/en/guides/integrations-guide/node/) adapter by default. If you want to deploy to Netlify or Vercel, you need their respective adapters:
...
| --- | --- | --- |
| `--primary` | The primary color of the page. | `#2323FF` |
...
Code snippets declared in `.md` and `.mdx` files are powered by [Expressive Code](https://expressive-code.com). By default, kshell uses a variation of GitHub's dark theme with custom background colors. 
